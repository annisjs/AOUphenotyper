...
#' @export
hf_hospitalization <- function(dataset,output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  query <- str_glue("
      SELECT  co.person_id,
  ...
  bq_table_save(
    ...
    paste0(output_folder,"/aou_phenotyper/hf_hospitalization_*.csv"),
    destination_format = "CSV")
  result <- read_bucket(paste0(output_folder,"/aou_phenotyper/hf_hospitalization_*.csv"))
