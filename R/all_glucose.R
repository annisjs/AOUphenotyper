...
#' @export
all_glucose <- function(dataset,output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  system(str_glue("gsutil cp all_glucose.csv {output_folder}/all_glucose.csv"),intern=TRUE)
}
