...
#' @export
cancer <- function(dataset,output_folder,anchor_date_table=NULL,before=NULL,after=NULL)
{
  ...
  result_all <- setDT(result_all)[,.(cancer_status = length(condition_start_date) > 0,
                                  ...
                                  .(person_id)]
  fwrite(result_all,file="cancer.csv")
  system(str_glue("gsutil cp cancer.csv {output_folder}/cancer.csv"),intern=TRUE)
}
